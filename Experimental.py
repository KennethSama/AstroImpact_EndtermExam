...
#     #         pg.draw.rect(SCREEN, (255, 0, 0), (*collider.topleft, *collider.get_size()), 2)
#     #     del collider, collider_rect
#
#     def Shoot(self, pos):
...
#     def SetCollider(self):
#         collider = self.sprite.get_rect(topleft=self.pos)
#         new_right = collider.width - 20
#         new_bottom = collider.height - 30
#         new_left = collider.left + 20
#         new_top = collider.top + 30
#         collider_rect = pg.Rect(new_left, new_top, new_right, new_bottom)
#         self.SetCenter(collider.center)
#         self.SetCorners((collider_rect.left, collider_rect.bottom, collider_rect.right, collider_rect.top))
#         if self.show_collider: pg.draw.rect(SCREEN, red, collider_rect, 3)
...
#                 enemy = Asteroid(enemy_sprites[rand_spawn], pos, speed, hp_start, hp_end, shoot_interval, name + str(rand_spawn), True, player.GetPos()[1], can_rotate)
#             else:
#                 enemy = Enemy(enemy_sprites[rand_spawn], pos, speed, hp_start, hp_end, shoot_interval, name + str(rand_spawn), True, player.GetPos()[1], can_rotate)
...
#                     end_boost += 0.5
#                     print('player_pos_x', player_pos_x)
#                     print('player_pos', player.GetPos())
#                     LevelFinish()
#
#         else:
